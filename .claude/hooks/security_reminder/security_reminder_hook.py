#!/usr/bin/env python3
# ============================================================================
# VENDORED FROM: anthropics/claude-plugins-official @ 4bf0858
# Path: plugins/security-guidance/hooks/security_reminder_hook.py
# Vendored on: 2026-05-19
# URL: https://github.com/anthropics/claude-plugins-official/tree/4bf0858/plugins/security-guidance
#
# This hook scans Edit/Write/MultiEdit tool inputs for risky security patterns
# (eval, exec, command injection, GitHub Actions workflow injection, etc.) and
# blocks the tool call with a reminder if found.
#
# Performance: ~130ms median (Python startup). Filetype filter via 'if' field
# in settings.json reduces invocations for non-code files (.md/.json/.txt).
#
# To update: re-run integration from new commit SHA, replace below the marker.
# To disable: set ENABLE_SECURITY_REMINDER=0 in shell env.
# ============================================================================
"""
