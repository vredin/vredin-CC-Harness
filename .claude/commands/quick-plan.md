...
`PLAN_OUTPUT_DIRECTORY/<name-of-plan>.md` that can be used as a blueprint for actual development work. Always use AskUserQuestion tool before starting.
...
```
✅ Implementation Pplan Created

File: PLAN_OUTPUT_DIRECTORY/.md
Topic: <brief describe what the plan covers>
Key Components:
– <main component 1>
– <main component 2>
– <main component 3>
